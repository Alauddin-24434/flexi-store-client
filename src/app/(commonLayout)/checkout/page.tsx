...
const CheckoutPage = () => {
    ...
    const [orderInitiate, { data, error ,isLoading}] = useOrderInitiateMutation();
    ...
    const handlePayment = async () => {
        ...
        try {
            ...
            const payload = {
                ...
                orderProducts: currentUserCartItems,

            }

            const response = await orderInitiate(payload).unwrap();
...
// cancel-payment?transactionId=TXN-1736875410015   cancel page fronend
// fail-payment?transactionId=TXN-1736875410015   fail page
    return (
                ...
                <div className="mt-10 bg-gray-50 px-4 pt-8 lg:mt-0">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            className={`w-full rounded-md border px-4 py-3 text-sm ${errors.phone ? "border-red-500" : ""
                                }`}
                        ...
                        <input
                            ...
                            className={`w-full rounded-md border px-4 py-3 text-sm ${errors.address ? "border-red-500" : ""
                                }`}
                            ...
                            <div className="mb-6">
                                ...
                                <div className="flex items-center mt-4">
                                    ...
                                    <button
                                        ...
                                        className="ml-2 rounded-md  px-4 py-2 text-sm font-medium bg-[#0d938f] text-white sm:text-base hover:bg-[#0b7671] "
                                    >
                                        Apply
                                    </button>
                                </div>
                    ...
                    <button onClick={handlePayment} className="uppercase w-full py-2 px-3 sm:py-3 sm:px-5 rounded-md bg-[#0d938f] text-white text-sm sm:text-base hover:bg-[#0b7671]">
                        Proceed to Payment
                    </button>

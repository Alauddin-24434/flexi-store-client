                ...
                <div className="flex justify-between flex-row gap-4 shrink-0">
                  {productData?.additionalImages?.map((image: string, index: number) => (
                    <Image
                      ...
                      className="w-[80px] h-[62px] border rounded-md cursor-pointer hover:border-indigo-500"
          ...
          <div className="w-full">
            <div>
              ...
              <div className="flex items-center flex-wrap gap-2 mt-4">
                ...
                <h4 className="text-[#0d938f] text-2xl sm:text-3xl font-bold">${productData?.price}</h4>
                {productData?.discount && (
                  <div className="flex py-1 px-2 bg-[#0d938f] font-semibold !ml-4">
                    <span className="text-white text-sm">Save {productData?.discount}%</span>
                  </div>
                )}
              </div>
            ...
            <div>
              <div className="flex gap-2 items-center border border-gray-300 bg-white px-3 py-2.5 w-max">
                <button onClick={decrementQuantity} className="border-none outline-none">
                  -
                </button>
                <span className="text-gray-800 text-sm font-semibold px-3">{quantity}</span>
                <button onClick={incrementQuantity} className="border-none outline-none">
                  +
                </button>
              </div>
  ...
  Buy it now
            ...
            <div className='flex justify-between gap-4 mt-6'>
              <div className="text-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="w-8 h-8 fill-[#0d938f] inline" viewBox="0 0 64 64">
                  <g data-name="Layer 2">
                    <path
              ...
              <div className="text-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="w-8 h-8 fill-[#0d938f] inline" viewBox="0 0 100 100">
                  <path
              ...
              <div className="text-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="w-8 h-8 fill-[#0d938f] inline" viewBox="0 0 32 32">

          ...
          <div className="w-full">
            <div>
              ...
              <div className="flex items-center flex-wrap gap-2 mt-4">
                ...
                <h4 className="text-purple-800 text-2xl sm:text-3xl font-bold">${productData?.price}</h4>
              ...
              <div>
                <h4 className="text-base mt-4 text-gray-500 font-semibold">{productData?.weight || "100g"}</h4>
              </div>
            </div>

                ...
                <div className="border py-3  ">
                    <div className="flex container mx-auto justify-between">
                        <div className="flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-[#008ECC]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                        ...
                        <div className="ml-6 flex flex-1 gap-x-3">
                            ...
                            <input type="text" className="w-full rounded-md border border-[#008ECC] px-3 py-2 text-sm" defaultValue="Search" />
                        </div>

                        <div className="ml-2 flex">
                            <div className="flex cursor-pointer items-center gap-x-1 rounded-md py-2 px-4 hover:bg-gray-100">
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-[#008ECC]" viewBox="0 0 20 20" fill="currentColor">
                    ...
                    <div className="flex items-center justify-center gap-6  mt-4 ">
                        <span className="cursor-pointer border-[#008ECC]  border rounded-md py-1 px-2 text-sm font-medium  hover:text-white">Best seller</span>
